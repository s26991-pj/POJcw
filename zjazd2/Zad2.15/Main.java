...
class VehicleProg {
    public void vehicleprog(String[] args) {
        ...
        System .out.println("Aby przejechać 200 km minivan potrzebuje " + minivan.fuelneeded(200) + " litrów paliwa");
        System .out.println("Aby przejechać 200 km sportscar potrzebuje " + sportscar.fuelneeded(200) + " litrów paliwa");
...
class Vehicle {
    ...
    public double fuelneeded(int kilometers) {
        return (double) lkm / 100 * kilometers ;
    }
}
